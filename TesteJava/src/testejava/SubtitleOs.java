...
public class SubtitleOs {
	...
	private String MatchedBy, IDSubMovieFile, MovieHash, MovieByteSize, MovieTimeMS,
			...
			UserNickName, ISO639, LanguageName, SubComments, SubHearingImpaired,
			UserRank, SeriesSeason, SeriesEpisode, MovieKind, SubDownloadLink,
			ZipDownloadLink, SubtitlesLink;
